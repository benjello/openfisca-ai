...
### 10. `generate_test_from_trace.py`

Convert an MCP `trace_calculation` response into a ready-to-use OpenFisca YAML
test. Inputs (provided non-null values) become the test inputs; outputs
