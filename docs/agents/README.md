...
Les points d'entrée principaux chargent automatiquement ces 3 niveaux :
...
2. Consulter [02-framework/roles/](02-framework/roles/) selon la tâche
3. Vérifier [03-countries/<pays>/specifics.md](03-countries/) si aménagements
...
3. Les agents chargent automatiquement la config via `config_loader.py`

## Inspiration

Basé sur [PolicyEngine/policyengine-claude](https://github.com/PolicyEngine/policyengine-claude) (21 agents pour US tax/benefits).
Voir [docs/policyengine-claude-agents.md](../policyengine-claude-agents.md) pour détails.
