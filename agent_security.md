...
limactl shell openfisca-france bash -l < "../openfisca-ai/src/script/agent-vm.setup.sh"
```
...
Enter the VM:
`limactl shell openfisca-france`

Stop a VM:
`limactl stop openfisca-france`

Start a VM:
`limactl start openfisca-france`
