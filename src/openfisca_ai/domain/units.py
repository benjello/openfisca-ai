...
USUAL_UNIT_DEFINITIONS: list[dict[str, Any]] = [
    ...
    {"name": "millimes", "label": {"one": "millime", "other": "millimes"}, "short_label": "millimes"},
    {"name": "millimes/kWh", "label": {"one": "millime par kilowatt-heure", "other": "millimes par kilowatt-heure"}, "short_label": "millimes/kWh"},
    {"name": "millimes/m3", "label": {"one": "millime par mètre cube", "other": "millimes par mètre cube"}, "short_label": "millimes/m³"},
